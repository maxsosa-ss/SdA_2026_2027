...
def load_medidas(df: pd.DataFrame) -> None:
    escribir_tabla_df(_SHEET_MEDIDAS, _RANGO_MEDIDAS, _prepare(df), clear_first=True)
    save_snapshot(df, 'amb_medidas')
